...
Memory (System):  13.79GB (4.66GB free)
VM:               0%
Screen Reader:    no
Process Argv:     --crash-reporter-id 454bcfe5-c2c3-403c-a803-9dd5ac98b4ee
...
CPU %   Mem MB     PID  Process
    0      131   25988  code main
    0       84    3192  ptyHost
    0      157    3200     window
    0      392    9476  extensionHost [1]
    0      130   17260     gpu-process
    0      185   17700  window [1] (Welcome - Visual Studio Code)
    0      116   20600  shared-process
    0      109   21812  fileWatcher [1]
    0       50   29120     utility-network-service
    0       33   29404     crashpad-handler""",
...
async def convert_keyvalue_to_json(question:str, file_path: str) -> str:
    """
...
async def analyze_sentiment(text: str, api_key: str = os.getenv("AIPROXY_TOKEN", "dummy_api_key")) -> str:
    """
...
async def compute_similarity(request: SimilarityRequest):
    ...
    async def get_embedding(text: str):
        ...
        headers = {
            "Content-Type": "application/json",
            "Authorization": f"Bearer {AIRPROXY_TOKEN}"  # Use environment variable
        }
        payload = {
            "model": "text-embedding-3-small",
            "input": text
...
"""
        ...
        return f"""{json.dumps(response, indent=2)}"""
    except Exception as e:
